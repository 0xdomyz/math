...
np.random.seed(42)
print("Setup complete for topic: backtesting and validation")
...
if confidence_intervals['sharpe'][0] > 0:
    print(f"\nâœ“ Strategy statistically significant (lower bound > 0)")
else:
    print(f"\nâœ— Strategy NOT statistically significant (includes zero)")
...
# %%
if 'df' in globals() and 'signal' in df.columns:
    ax = df.plot(x='t', y='signal', figsize=(10, 4), title='backtesting and validation - Signal View')
