...
## Concept Skeleton
- **Definition**: Monte Carlo Fundamentals is a derivative pricing topic that translates market assumptions into a valuation and risk view for a specific contract class.
