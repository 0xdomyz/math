...
np.random.seed(42)
print("Setup complete for topic: twap time weighted average price")
...
# %%
if 'df' in globals() and 'signal' in df.columns:
    ax = df.plot(x='t', y='signal', figsize=(10, 4), title='twap time weighted average price - Signal View')
