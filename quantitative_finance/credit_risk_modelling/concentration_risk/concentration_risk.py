# %%
# VSCode Interactive: Portfolio Concentration Risk Analysis
# Auto-converted to interactive format

# %% [markdown]
# ## Section 1: Overview & Setup
# 
# This notebook analyzes portfolio concentration risk using various metrics:
# - **Herfindahl-Hirschman Index (HHI)**: Measures portfolio concentration
# - **Numbers Equivalent (N_eq)**: Equivalent number of equal-sized exposures
# - **Gini Coefficient**: Income inequality measure applied to exposures
# - **Lorenz Curve**: Visual representation of concentration
# 
# We'll create three portfolios with different concentration levels and analyze their risk characteristics.
