# 00 Monte Carlo Pricing Topics Guide

## Concept Skeleton
- **Definition**: 00 Monte Carlo Pricing Topics Guide is a derivative pricing topic that translates market assumptions into a valuation and risk view for a specific contract class.
