...
np.random.seed(42)
print("Setup complete for topic: definition and overview")
...
for i, strategy in enumerate(strategies):
    ...
    print(f"\n{strategy_name}:")
    print(f"   Avg Slippage: {avg_slip:.2f} Â± {std_slip:.2f} bps")
...
print("\n" + "="*70)
print("âœ“ Visualization saved: algorithmic_trading_overview.png")
plt.show()
...
# %%
if 'df' in globals() and 'signal' in df.columns:
    ax = df.plot(x='t', y='signal', figsize=(10, 4), title='definition and overview - Signal View')
