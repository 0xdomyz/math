# Multivariate Correlated Paths

## Concept Skeleton
- **Definition**: Multivariate Correlated Paths is a derivative pricing topic that translates market assumptions into a valuation and risk view for a specific contract class.
